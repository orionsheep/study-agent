...
DATABASE_URL="${DATABASE_URL:-postgresql://learnforge:learnforge@127.0.0.1:5432/learnforge}" "$ROOT/.venv/bin/uvicorn" app.main:app --app-dir services/api --host 127.0.0.1 --port "$API_PORT" >"$API_LOG" 2>&1 &
API_PID=$!
