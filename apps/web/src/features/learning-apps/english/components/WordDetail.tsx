  ...
  const renderCollinsStars = (collins: string | undefined) => {
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: 2, marginLeft: 8 }} title={`柯林斯星级: ${stars}`}>
        {[...Array(stars)].map((_, i) => (
          <svg key={i} style={{ width: 14, height: 14, color: 'var(--ew-warning, #eab308)', fill: 'currentColor' }} viewBox="0 0 24 24">
    ...
    return (
      <div
        style={{
          ...
          color: 'var(--ew-text-faint, #737373)',
          fontWeight: 300,
          letterSpacing: '0.05em',
          background: 'var(--ew-bg-panel, #0a0a0a)',
        }}
      >
        选择一个单词查看详情
      </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '24px 24px 16px', borderBottom: '1px solid #171717' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button
              ...
              title="美式发音 (J)"
              onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--ew-border, #262626)'; e.currentTarget.style.color = 'var(--ew-accent-light, #60a5fa)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'var(--ew-bg-card, #171717)'; e.currentTarget.style.color = 'var(--ew-text-3, #a3a3a3)'; }}
            >
            ...
            <button
              ...
              title="英式发音 (K)"
              onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--ew-border, #262626)'; e.currentTarget.style.color = '#f87171'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'var(--ew-bg-card, #171717)'; e.currentTarget.style.color = 'var(--ew-text-3, #a3a3a3)'; }}
            >
        ...
        {chineseData && (
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, color: 'var(--ew-text-3, #a3a3a3)', fontFamily: 'monospace', fontSize: 14, marginBottom: 8 }}>
              <span>/{chineseData.phonetic || chineseData.pronunciation}/</span>
              {renderCollinsStars(chineseData.collins)}
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
              <div style={{ flex: 1, fontSize: 18, color: 'var(--ew-text-2, #d4d4d4)', fontWeight: 500 }}>
              ...
              <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                ...
                <button
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.color = 'var(--ew-text-1, #fff)'; e.currentTarget.style.borderColor = 'var(--ew-border-hi, #404040)'; }}
                  onMouseLeave={(e) => { e.currentTarget.style.color = 'var(--ew-text-3, #a3a3a3)'; e.currentTarget.style.borderColor = 'var(--ew-border, #262626)'; }}
                >
                  <ArrowDown size={12} />
                  <span>查看笔记</span>
                </button>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '24px 24px 32px' }}>
        {/* Markdown Content */}
        {loading && (
          <div style={{ marginBottom: 24, color: 'var(--ew-text-faint, #737373)', fontSize: 14 }}>
            加载 {word} 中...
          </div>
        )}
        {content && (
              ...
              components={{
                a: (props) => (
                  <button
                    ...
                    style={{
                      color: 'var(--ew-accent-light, #60a5fa)',
                ...
                small: (props) => (
                  <span {...props} style={{ fontSize: 10, color: 'var(--ew-text-faint, #737373)', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 700, margin: '0 4px' }} />
                ),
                p: (props) => (
                  <div {...props} style={{ marginBottom: 8, color: 'var(--ew-text-2, #d4d4d4)', lineHeight: 1.75 }} />
                ),
                strong: (props) => (
                  <strong {...props} style={{ color: 'var(--ew-warning-light, #fef08a)', fontWeight: 700 }} />
                ),
                em: (props) => (
                  <em {...props} style={{ color: 'var(--ew-text-3, #a3a3a3)' }} />
                ),
              }}
            >
              {content}
          ...
          <div style={{ borderTop: '1px solid #171717', paddingTop: 24, marginBottom: 32 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
              {Object.entries(chineseData.forms).map(([key, value]) => (
                ...
                >
                  <span style={{ color: 'var(--ew-text-faint, #737373)', fontSize: 11, textTransform: 'uppercase', fontWeight: 700, letterSpacing: '0.05em', marginRight: 8 }}>
                    {key}
                  </span>
                  <span style={{ color: 'var(--ew-text-1, #e5e5e5)', fontWeight: 500 }}>{value}</span>
                </div>
              ))}
            </div>
          </div>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                    <span
                      style={{
                        padding: '2px 8px',
                        background: 'var(--ew-border, #262626)',
                        color: 'var(--ew-text-3, #a3a3a3)',
                        fontSize: 11,
                        borderRadius: 4,
              ...
              {chineseData.comparison.map((comp, idx) => (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 8 }}>
                    <span style={{ color: 'var(--ew-purple-light, #c084fc)', fontWeight: 700, fontSize: 18 }}>{comp.word_to_compare}</span>
                    <span style={{ color: 'var(--ew-text-faint, #737373)', fontSize: 14 }}>vs {word}</span>
                  </div>
                  <p style={{ color: 'var(--ew-text-2, #d4d4d4)', lineHeight: 1.7, fontSize: 14, margin: 0 }}>{comp.analysis}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {myNotes.length > 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {myNotes.map((note) => (
                ...
                >
                  <p style={{ fontSize: 14, color: 'var(--ew-text-2, #d4d4d4)', lineHeight: 1.6, whiteSpace: 'pre-wrap', margin: 0 }}>
                    {note.content}
                  </p>
                  <p style={{ fontSize: 12, color: 'var(--ew-text-3, #525252)', marginTop: 8 }}>
            ...
            <div style={{ textAlign: 'center', padding: '32px 0', color: 'var(--ew-text-faint, #737373)' }}>暂无笔记</div>
          )}
        </div>
      </div>
    </div>
