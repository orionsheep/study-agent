        ...
        {chineseData && (
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
              <div style={{ flex: 1, fontSize: 18, color: 'var(--text-2)', fontWeight: 500 }}>
          ...
          >
            <ReactMarkdown
              ...
              components={{
                ...
                p: (props) => (
                  <div {...props} style={{ marginBottom: 8, color: 'var(--text-2)', lineHeight: 1.75 }} />
                ),
                strong: (props) => (
              ...
              {chineseData.definitions.map((def, idx) => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    <div>
                      <p style={{ color: 'var(--text-1)', margin: '0 0 4px' }}>{def.explanation_en}</p>
                    ...
                    <div style={{ paddingLeft: 12, borderLeft: '2px solid #404040' }}>
                      <p style={{ color: 'var(--text-2)', fontStyle: 'italic', margin: '0 0 4px' }}>"{def.example_en}"</p>
              ...
              {chineseData.comparison.map((comp, idx) => (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 8 }}>
                    <span style={{ color: '#a855f7', fontWeight: 700, fontSize: 18 }}>{comp.word_to_compare}</span>
                    <span style={{ color: 'var(--text-faint)', fontSize: 14 }}>vs {word}</span>
                  </div>
                  <p style={{ color: 'var(--text-2)', lineHeight: 1.7, fontSize: 14, margin: 0 }}>{comp.analysis}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {myNotes.length > 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {myNotes.map((note) => (
                ...
                >
                  <p style={{ fontSize: 14, color: 'var(--text-2)', lineHeight: 1.6, whiteSpace: 'pre-wrap', margin: 0 }}>
                    {note.content}
                  </p>
