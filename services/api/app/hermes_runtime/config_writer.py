        ...
        native_config_path.write_text(
            "\n".join(
                [
                    ...
                    # 激活自研 EduMem0 记忆 provider(按 student_id 隔离)。
                    # memory.provider 由 Hermes agent_init 读取并加载
                    # $HERMES_HOME/plugins/edumem0/ 下的 provider。
                    "memory:",
                    "  provider: edumem0",
                    "",
                ]
